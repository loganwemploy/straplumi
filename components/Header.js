...
<div className="navigation-wrap bg-light start-header start-style" style={{width: '100%',maxWidth:'100vw'}}>
    ...
    <div className="container">
        <div className="row">
            <div className="col-12 nav-holder" style={{display:'flex'}}>
                   <a className="navbar"  style={{justifyContent:'flex-end',width:'55vw'}}>
                 <Link href="/"> 
                ...
                <nav className="navbar navbar-expand-md navbar-light" style={{display:'flex',justifyContent:'flex-end',width:'45vw'}}>
